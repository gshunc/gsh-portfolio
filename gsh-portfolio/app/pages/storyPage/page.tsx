...
import { Spotify_IFrame } from "../../components/storyComponents/Spotify_IFrame";
config.autoAddCss = false;

const story_page = () => {
  return (
    <main className="flex min-h-screen flex-col items-start mr-20">
      <p className="self-center border border-gray-300 bg-yellow-300 bg-opacity-70 text-black text-center p-6 mt-10 mb-10 backdrop-blur-2xl rounded-lg">
